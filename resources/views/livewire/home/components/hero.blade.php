...
<div
    ...
    <h1 class="text-3xl font-sourceSans font-bold tracking-tight leading-10 text-center text-secondary md:text-center sm:text-4xl md:text-6xl lg:text-7xl">
        ...
        setInterval(function(){
            ...
            <div class="relative flex items-center justify-center h-10 md:h-24">
                <h1 class="text-4xl sm:text-4xl md:text-8xl lg:text-9xl font-sourceSans font-black text-white"
                    x-text="text"></h1>
